...
%>
       ...
       <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
        ...
        <li class="<%= currentPage.endsWith("/semantic-search.jsp")? "active" : "" %>"><a href="<%= request.getContextPath() %>/semantic-search">
        <fmt:message key="jsp.layout.navbar-default.semantic"/></a></li>
